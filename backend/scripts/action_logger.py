...
Dùng để ghi lại hành động của từng Agent trong mô phỏng OASIS, phục vụ backend giám sát
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Đường dẫn thư mục mô phỏng gốc
        """
...
class SimulationLogManager:
    """
    Trình quản lý log mô phỏng
    Quản lý thống nhất mọi tệp log, tách riêng theo nền tảng
    """
    
    def __init__(self, simulation_dir: str):
        """
        Khởi tạo trình quản lý log
...
class ActionLogger:
    """
    Trình ghi log hành động (tương thích giao diện cũ)
